...
function Navbar({ language, setLanguage }) {
    ...
    return (
        <div id="navbar" className="navbar fixed w-full top-0 left-0 z-[10000] bg-transparent">
            <div className="container flex items-center max-sm:justify-center max-sm:flex-wrap justify-between border-[1px] border-[white] text-white rounded-full mt-[20px] py-[15px] max-xl:py-[10px] !px-[50px]">
                <Link to="/">
